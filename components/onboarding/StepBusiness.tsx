...
export function StepBusiness({ lang, session, saving, onNext, onBack, step, total }: StepProps) {
  ...
  return (
    <div>
      ...
      <h1 className="text-2xl font-bold text-zinc-900 mb-4">{getText(lang, 'step5Title')}</h1>
      <p className="text-sm text-zinc-500 mb-6">{getText(lang, 'step5Subtitle')}</p>
      <form onSubmit={handleSubmit} className="space-y-5">
        <div>
          <label className="block text-sm font-medium text-zinc-700 mb-1">{getText(lang, 'productDescription')}</label>
          <p className="text-xs text-zinc-400 mb-1">{getText(lang, 'productDescriptionHint')}</p>
          <textarea
        ...
        <div>
          <label className="block text-sm font-medium text-zinc-700 mb-1">{getText(lang, 'productPrice')}</label>
          <input
            type="number"
            min="0"
            step="0.01"
          ...
          />
          <p className="text-xs text-zinc-400 mt-1">{getText(lang, 'productPriceHint')}</p>
        </div>
        <div>
        ...
        <div>
          <label className="block text-sm font-medium text-zinc-700 mb-1">{getText(lang, 'monthlyRevenue')}</label>
          <input
            type="number"
            min="0"
            step="0.01"
